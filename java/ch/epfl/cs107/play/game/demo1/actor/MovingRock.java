...
public class MovingRock extends GraphicsEntity {
	...
	/**
	 * Creates a new moving rock.
	 * 
	 * @param position (Vector): rock's position
	 * @param text     (String): rock's associated text
	 */
	public MovingRock(Vector position, String text) {
		...
		this.text.setAnchor(new Vector(0.1f, 0.1f));
	}

	/** @return (TextGraphics): rock's associated text */
