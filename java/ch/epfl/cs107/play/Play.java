...
public class Play {
    ...
    public static void main(String[] args) {
        ...
        final FileSystem fileSystem = new ResourceFileSystem(
        ...
        // Use Swing display
        final Window window = new SwingWindow(game.getTitle(), fileSystem, 750,
                750);
        ...
        try {
            ...
            if (game.begin(window, fileSystem)) {
                ...
                while (!window.isCloseRequested()) {
                    ...
                    try {
                        int timeDiff = Math.max(0,
                                (int) (frameDuration - deltaTime));
                        Thread.sleep((int) (timeDiff / 1E6),
                                (int) (timeDiff % 1E6));
